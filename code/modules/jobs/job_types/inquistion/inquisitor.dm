/datum/job/inquisitor
	...
	tutorial = "This is the week. All your lessons have led to this moment. Your apprentice follows you with eager steps and breathless anticipation. You’re to aid and observe their hunt, and see if they can banish the evils haunting Psydonia, and rise up to become a true inquisitor. A guide to them, a monster to others. You are the thing that goes bump in the night."
